...
const props = defineProps({
  ...
  color: {
    ...
    default: 'cyan',
    validator: (val) =>
      ['cyan', 'red', 'blue', 'green', 'pink', 'purple', 'amber', 'lime'].includes(val),
  },
})
